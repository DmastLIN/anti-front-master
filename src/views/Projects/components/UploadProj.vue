<template>
  <div>
    ...
    {{ state.mode }}
      <template #dropdown>
        <el-dropdown-menu>
          <el-dropdown-item command="新建任务"
            >任务管理</el-dropdown-item
          >
  ...
  >
    ...
    <div class="add-dialog">
      <el-form
        ...
        label-width="120px"
      >
        <el-form-item label="任务名" prop="project_name" required>
          <el-input
            v-model="projectForm.project_name"
            placeholder="任务的名称"
          />
        </el-form-item>
        <el-form-item label="伴生仓库" prop="repository" required>
          <el-input
        ...
        <el-form-item label="原生节点" prop="proto" required>
          <el-input
            v-model="projectForm.version"
            placeholder="input"
          />
        </el-form-item>
        <el-form-item label="伴生节点" prop="assoc" required>
          <el-input
            v-model="projectForm.version"
            placeholder="input"
          />
